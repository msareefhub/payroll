...
import BankDetailsTab from '../../common/BankDetails';
  ...
  return (
    <>
      <Grid item xs={12} md={7} lg={12}>
        <Grid item xs={12} md={7} lg={12}>
          <TitleWrapper>
            <Typography variant="h5">Employee Documents Details List</Typography>
          </TitleWrapper>
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={4} lg={12}>
          <MainCard sx={{ p: 4 }} content={false}>
            <Flex gap={12}>
              ...
              />
              <Button type="primary" onClick={() => loadEmployeeDocumentDetails()}>
                Submit
              </Button>
            </Flex>
          </MainCard>
        ...
        {isSubmit && <BankDetailsTab employeeId={currentEmployee} />}
      </Grid>
    </>
  );
}
